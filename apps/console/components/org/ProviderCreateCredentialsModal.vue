<template>
  ...
  >
    <template #body>
      <div class="space-y-4">
        <p class="text-sm text-muted">Enter the Access Key ID and Secret Access Key for the IAM role you have created. For more information, see <NuxtLink class="text-white" target="_blank" to="https://thunder.so/docs/aws">documentation</NuxtLink></p>
